...
class Builder(args: Array<String>) {
    ...
    init {
        ...
        when (args[0]) {
            ...
            "stroyserv" -> arg = Arguments.STROYSERV
            "molskaz" -> arg = Arguments.MOLSKAZ
            "akbars" -> arg = Arguments.AKBARS
            "snm" -> arg = Arguments.SNM
            "mmkcoal" -> arg = Arguments.MMKCOAL
            "prneft" -> arg = Arguments.PRNEFT
