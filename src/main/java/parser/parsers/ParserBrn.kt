...
import parser.tenders.TenderBrn
...
class ParserBrn : IParser, ParserAbstract() {
    private val tendersS = mutableListOf<TenderBrn>()

    companion object WebCl {
        const val BaseUrl = "https://zm-tender32.rts-tender.ru/"
