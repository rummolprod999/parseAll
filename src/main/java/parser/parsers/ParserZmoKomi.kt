...
import parser.tenders.TenderZmoKomi
...
class ParserZmoKomi : IParser, ParserAbstract() {
    private val tendersS = mutableListOf<TenderZmoKomi>()

    companion object WebCl {
        const val BaseUrl = "https://komimarket-app.rts-tender.ru/"
