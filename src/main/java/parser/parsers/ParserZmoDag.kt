...
import parser.tenders.TenderZmoDag
...
class ParserZmoDag : IParser, ParserAbstract() {
    private val tendersS = mutableListOf<TenderZmoDag>()

    companion object WebCl {
        const val BaseUrl = "https://marketrd.rts-tender.ru/"
