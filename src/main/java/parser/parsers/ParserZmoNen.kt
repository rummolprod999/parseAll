...
import parser.tenders.TenderZmoNen
...
class ParserZmoNen : IParser, ParserAbstract() {
    private val tendersS = mutableListOf<TenderZmoNen>()

    companion object WebCl {
        const val BaseUrl = "https://naomarket-app.rts-tender.ru/"
