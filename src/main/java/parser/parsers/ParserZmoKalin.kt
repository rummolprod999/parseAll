...
import parser.tenders.TenderZmoKalin
...
class ParserZmoKalin : IParser, ParserAbstract() {
    private val tendersS = mutableListOf<TenderZmoKalin>()

    companion object WebCl {
        const val BaseUrl = "https://market.gov39.ru/"
