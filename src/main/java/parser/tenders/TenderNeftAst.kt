...
class TenderNeftAst(val drv: ChromeDriver) : TenderAbstract(), ITender {

    var idTender = 0

    init {
        etpName = "«Сбербанк - Автоматизированная система торгов» - Торги нефтегазовой отрасли и электроэнергетики"
        etpUrl = "http://utp.sberbank-ast.ru/Neft/List/PurchaseList"
    }
