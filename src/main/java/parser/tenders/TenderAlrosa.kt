...
class TenderAlrosa(val tn: Alrosa) : TenderAbstract(), ITender {
    ...
    override fun parsing() {
        val (purNum: String, url: String, purObj: String, pubDate: Date, endDate: Date, status: String, placingWayName: String, nameCus: String, nmck: String, currency: String, fullnameOrg: String, contactPerson: String, phone: String, email: String, products: MutableList<AlrosaProduct>) = tn
        val dateVer = Date()
