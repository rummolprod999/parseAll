...
class TenderZmoYalta(val tn: ZmoKursk) : TenderAbstract(), ITender {
    init {
        etpName = "Электронный магазин Администрации города Ялта"
        etpUrl = "https://yalta-zmo.rts-tender.ru/"
    }
