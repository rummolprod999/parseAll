...
class TenderRetailAst(val drv: ChromeDriver) : TenderAbstract(), ITender {

    var idTender = 0

    init {
        etpName = "«Сбербанк - Автоматизированная система торгов» - Ритейл"
        etpUrl = "http://utp.sberbank-ast.ru/Retail/List/PurchaseList"
    }
