...
class TenderExUzex(
    ...
    init {
        etpName =
            "АО \"Узбекская Республиканская товарно-сырьевая биржа\" для корпоративных заказчиков"
        etpUrl = "https://exarid.uzex.uz/ru"
    }

    val typeFz by lazy { 222 }
    ...
    private fun insertPurObjs(
        purchaseObjects: Elements,
        con: Connection,
        idLot: Int,
        idCustomer: Int,
    ) {
    ...
    private fun insertRequirements(
