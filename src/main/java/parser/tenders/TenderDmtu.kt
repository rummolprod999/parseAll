...
class TenderDmtu(val tn: Dmtu) : TenderAbstract(), ITender {


    init {
        etpName = " АНО \"ДИРЕКЦИЯ МОСКОВСКОГО ТРАНСПОРТНОГО УЗЛА\""
        etpUrl = "http://anomtu.ru/zakupki/"
    }
